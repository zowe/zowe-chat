...
async function startLocalTask() {
    ...
    childProcess.execSync(`rsync -r --exclude 'config' ${projectRoot}/packages/chat/dist/* ${zoweChatHome}`, { stdio: 'inherit' });
    childProcess.execSync(`rsync -r --ignore-existing ${projectRoot}/packages/chat/dist/config/* ${zoweChatHome}/config`, { stdio: 'inherit' });
    childProcess.execSync(`rsync -r --ignore-existing ${projectRoot}/packages/chat/dist/config/plugin.yaml ${zoweChatPluginHome}`, { stdio: 'inherit' });
    console.log('Done!');
    ...
    childProcess.execSync(`rsync -r ${projectRoot}/packages/zos/dist/* ${zoweChatPluginHome}/@zowe/zos`, { stdio: 'inherit' });
    console.log('Done!');

    // Synchronize @zowe/clicmd
    console.log('Synchronizing @zowe/clicmd ...');
    childProcess.execSync(`rsync -r ${projectRoot}/packages/clicmd/dist/* ${zoweChatPluginHome}/@zowe/clicmd`, { stdio: 'inherit' });
    console.log('Done!');
...
async function packagingTask() {
    try {
        ...
        if (process.env.RELEASE_TYPE === undefined || ['beta', 'ga'].includes(process.env.RELEASE_TYPE.toLowerCase()) === false) { // beta, ga
        ...
        childProcess.execSync(`cp ${projectRoot}/packages/chat/dist/config/plugin.yaml ${pluginReleaseDir}/.`, { stdio: 'inherit' });
        console.log('Done!');
        console.log('Copying @zowe/webapp ...');
        childProcess.execSync(`cp -R ${projectRoot}/packages/webapp/build/* ${zoweChatReleaseDir}/webapp/.`, { stdio: 'inherit' });
        console.log('Done!');
        console.log('Copying @zowe/zos ...');
        childProcess.execSync(`cp -R ${projectRoot}/packages/zos/dist/* ${pluginReleaseDir}/@zowe/zos/.`, { stdio: 'inherit' });
        console.log('Done!');
        console.log('Copying @zowe/clicmd ...');
        childProcess.execSync(`cp -R ${projectRoot}/packages/clicmd/dist/* ${pluginReleaseDir}/@zowe/clicmd/.`, { stdio: 'inherit' });
        console.log('Done!');
        ...
        console.log('===================================================');
        childProcess.execSync(`cd ${zoweChatReleaseDir}/.. && tar zcf ./${packageFileName} ./zoweChat ./plugins`, { stdio: 'inherit' });
        ...
        console.log('===================================================');
        childProcess.execSync(`cd ${zoweChatReleaseDir}/.. && shasum -a 256 ${packageFileName} > checksum.sha256`, { stdio: 'inherit' });
