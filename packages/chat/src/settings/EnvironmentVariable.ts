...
export class EnvironmentVariable {
    ...
    //     Priority: process argument > environment variable > default value
    public static ZOWE_CHAT_CONFIG_HOME: string = EnvironmentVariable.getStringVariable('ZOWE_CHAT_CONFIG_HOME', `${EnvironmentVariable.ZOWE_CHAT_HOME}/config`);

    // <Optional> The directory where Zowe Chat plugins are installed
    //     Priority: process argument > environment variable > default value
    public static ZOWE_CHAT_PLUGIN_HOME: string = EnvironmentVariable.getStringVariable('ZOWE_CHAT_PLUGIN_HOME', `${EnvironmentVariable.ZOWE_CHAT_HOME}/plugin`);
