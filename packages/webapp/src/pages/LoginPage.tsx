...
export function LoginPage() {
    ...
    if (loginHash === undefined || loginHash === null || loginHash.trim().length === 0) {
      loginHint = (
        <Alert severity="warning">
          You are logging in without being sent here by Zowe ChatBot. Please use a link provided by the Bot.
        </Alert>
      );
    } else {
      ...
      loginHint = (
        <p text-align="center">
          Welcome, {userInfo[0]}. <br />
          <br />
          Ensure this is your private login link with your display name here.<br></br>Please log in with your Mainframe user ID for
          authentication to use Zowe Chat bot.
        </p>
      );
    }
  ...
  return (
    <div id="login">
      <div text-align="center">{loginHint}</div>
      {alertState}
      <br />
      {loginForm}
    </div>
