...
import ZosCommandIssueConsoleMattermostView from './ZosCommandIssueConsoleMattermostView';
import ZosCommandIssueConsoleMsteamsView from './ZosCommandIssueConsoleMsteamsView';
import ZosCommandIssueConsoleSlackView from './ZosCommandIssueConsoleSlackView';
    ...
    public async issueConsoleCommand(command: ICommand, executor: IExecutor): Promise<IMessage[]> {
        ...
        try {
            ...
            if(issueResponse.success === true){
                ...
                // } else {
                //     messages = this.view.getDetail(issueResponse, executor);
                // }
            }
        } catch (error) {
