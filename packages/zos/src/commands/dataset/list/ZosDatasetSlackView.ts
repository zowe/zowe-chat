      ...
      for (const dataset of datasets) {
        ...
        const datasetSection = {
          ...
          fields: [
            {
              type: 'mrkdwn',
              text: `${isPartitioned === true ? ':card_index_dividers:' : ':page_with_curl:'} *${i18next.t(
            ...
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.status.organization', { ns: 'ZosMessage' })}:* ${
            ...
            },
            {
              type: 'mrkdwn',
              text:
                `*${i18next.t('command.dataset.list.status.logicalRecordLength', { ns: 'ZosMessage' })}:* ` +
      ...
      blockObject.blocks.push(
        {
          ...
          fields: [
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.organization', { ns: 'ZosMessage' })}:* ${
                dataset.dsorg ? dataset.dsorg : ''
              }`,
            },
            {
            ...
            },
            {
              type: 'mrkdwn',
              text:
                `*${i18next.t('command.dataset.list.detail.logicalRecordLength', { ns: 'ZosMessage' })}:* ` +
                `${dataset.lrecl ? dataset.lrecl : ''}`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.spaceUnits', { ns: 'ZosMessage' })}:* ${
                dataset.spacu ? dataset.spacu : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.usedExtents', { ns: 'ZosMessage' })}:* ${
            ...
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.recordFormat', { ns: 'ZosMessage' })}:* ${
                dataset.recfm ? dataset.recfm : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.multiVolume', { ns: 'ZosMessage' })}:* ${
        ...
        },
        {
          ...
          fields: [
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.volumeSerial', { ns: 'ZosMessage' })}:* ${
                dataset.vol ? dataset.vol : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.deviceType', { ns: 'ZosMessage' })}:* ${
            ...
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.creationDate', { ns: 'ZosMessage' })}:* ${
                dataset.cdate ? dataset.cdate : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.detail.lastReferenceDate', { ns: 'ZosMessage' })}:* ${
      ...
      blockObject.blocks.push(
        {
          ...
          fields: [
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.memberDetail.user', { ns: 'ZosMessage' })}:* ${
                member.mtime ? member.user : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.memberDetail.sclm', { ns: 'ZosMessage' })}:* ${
                member.mtime ? member.sclm : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.memberDetail.version', { ns: 'ZosMessage' })}:* ${
                member.vers ? member.vers : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.memberDetail.modification', { ns: 'ZosMessage' })}:* ${
            ...
            },
            {
              type: 'mrkdwn',
              text:
                `*${i18next.t('command.dataset.list.memberDetail.creationTime', { ns: 'ZosMessage' })}:* ` +
                `${member.ec4datextx ? member.c4date : ''}`,
            },
            {
              type: 'mrkdwn',
              text:
                `*${i18next.t('command.dataset.list.memberDetail.modificationDate', { ns: 'ZosMessage' })}:* ` +
                `${member.m4date ? member.m4date : ''}`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.memberDetail.currentRecords', { ns: 'ZosMessage' })}:* ${
                member.cnorc ? member.cnorc : ''
              }`,
            },
            {
              type: 'mrkdwn',
              text: `*${i18next.t('command.dataset.list.memberDetail.initialRecords', { ns: 'ZosMessage' })}:* ${
            ...
            },
            {
              type: 'mrkdwn',
              text:
                `*${i18next.t('command.dataset.list.memberDetail.modificationTime', { ns: 'ZosMessage' })}:* ` +
