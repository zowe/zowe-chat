...
class ZosDatasetMattermostView extends ChatMattermostView {
  ...
  getOverview(datasets: Record<string, unknown>[], executor: IExecutor, command: ICommand): IMessage[] {
    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              ...
              resourceName: i18next.t('command.dataset.list.status.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      for (const dataset of datasets) {
        ...
        if (dataset.dsorg && (dataset.dsorg === 'PO' || dataset.dsorg === 'POU' || dataset.dsorg === 'PO-E')) {
          isPartitioned = true;
        }
        fields.push(
          {
            short: true,
            value: `${isPartitioned === true ? ':card_index_dividers:' : ':page_with_curl:'} **${i18next.t(
              'command.dataset.list.status.name',
              { ns: 'ZosMessage' },
            )}:** ${dataset.dsname}`,
          },
          {
            short: true,
            value: `**${i18next.t('command.dataset.list.status.organization', { ns: 'ZosMessage' })}:** ${
              dataset.dsorg ? dataset.dsorg : ''
            }`,
          },
          {
            short: true,
          ...
          {
            short: true,
            value: `**${i18next.t('command.dataset.list.status.logicalRecordLength', { ns: 'ZosMessage' })}:** ${
      ...
      super.addMenuAction(
        actions,
        i18next.t('command.dataset.list.status.detailDropDownPlaceholder', { ns: 'ZosMessage' }),
        contextData,
        detailOptions,
      );
      super.addMenuAction(
        actions,
        i18next.t('command.dataset.list.status.memberDropDownPlaceholder', { ns: 'ZosMessage' }),
        contextData,
        memberOptions,
      );
  ...
  getDetail(datasets: Record<string, unknown>[], executor: IExecutor, command: ICommand): IMessage[] {
    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              executor: executor.name,
              resourceName: i18next.t('command.dataset.list.detail.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      fields.push(
        ...
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.organization', { ns: 'ZosMessage' })}:** ${
            dataset.dsorg ? dataset.dsorg : ''
          }`,
        },
        {
        ...
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.logicalRecordLength', { ns: 'ZosMessage' })}: ** ${
            dataset.lrecl ? dataset.lrecl : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.spaceUnits', { ns: 'ZosMessage' })}: ** ${
            dataset.spacu ? dataset.spacu : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.usedExtents', { ns: 'ZosMessage' })}: ** ${
            dataset.extx ? dataset.extx : ''
          }`,
        },
        {
          short: true,
        ...
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.recordFormat', { ns: 'ZosMessage' })}: ** ${
            dataset.recfm ? dataset.recfm : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.multiVolume', { ns: 'ZosMessage' })}: ** ${
            dataset.mvol ? dataset.mvol : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.volumeSerial', { ns: 'ZosMessage' })}: ** ${
            dataset.vol ? dataset.vol : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.deviceType', { ns: 'ZosMessage' })}: ** ${
        ...
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.creationDate', { ns: 'ZosMessage' })}: ** ${
            dataset.cdate ? dataset.cdate : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.detail.lastReferenceDate', { ns: 'ZosMessage' })}: ** ${
            dataset.rdate ? dataset.rdate : ''
          }`,
        },
      );
  ...
  getMemberOverview(members: Record<string, unknown>[], executor: IExecutor, command: ICommand): IMessage[] {
    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              executor: executor.name,
              resourceName: i18next.t('command.dataset.list.member.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      super.addMenuAction(
        actions,
        i18next.t('command.dataset.list.member.attributeDropDownPlaceholder', { ns: 'ZosMessage' }),
        contextData,
        detailOptions,
      );
  ...
  getMemberDetail(members: Record<string, unknown>[], executor: IExecutor): IMessage[] {
    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              executor: executor.name,
              resourceName: i18next.t('command.dataset.list.memberDetail.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      fields.push(
        ...
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.version', { ns: 'ZosMessage' })}: ** ${
            member.vers ? member.vers : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.modification', { ns: 'ZosMessage' })}: ** ${
            member.mod ? member.mod : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.creationTime', { ns: 'ZosMessage' })}: ** ${
            member.ec4datextx ? member.c4date : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.modificationDate', { ns: 'ZosMessage' })}: ** ${
            member.m4date ? member.m4date : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.currentRecords', { ns: 'ZosMessage' })}: ** ${
            member.cnorc ? member.cnorc : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.initialRecords', { ns: 'ZosMessage' })}: ** ${
            member.inorc ? member.inorc : ''
          }`,
        },
        {
          short: true,
        ...
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.modificationTime', { ns: 'ZosMessage' })}: ** ${
            member.mtime ? member.mtime : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.user', { ns: 'ZosMessage' })}: ** ${
            member.mtime ? member.user : ''
          }`,
        },
        {
          short: true,
          value: `**${i18next.t('command.dataset.list.memberDetail.sclm', { ns: 'ZosMessage' })}: ** ${
            member.mtime ? member.sclm : ''
          }`,
        },
      );
