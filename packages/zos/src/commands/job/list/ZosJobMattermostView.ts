    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              ...
              resourceName: i18next.t('command.job.list.status.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      for (job of jobs) {
        fields.push(
          ...
          {
            short: true,
            value: `**${i18next.t('command.job.list.status.returnCode', { ns: 'ZosMessage' })}:** ${
      ...
      super.addMenuAction(
        actions,
        i18next.t('command.job.list.status.dropDownPlaceholder', { ns: 'ZosMessage' }),
        actionData,
        detailOptions,
      );
  ...
  getDetail(jobs: IJob[], executor: IExecutor): IMessage[] {
    ...
    try {
      ...
      fields.push(
        ...
        {
          short: true,
          value: `**${i18next.t('command.job.list.detail.returnCode', { ns: 'ZosMessage' })}:** ${
            job.retcode === null ? ' ' : job.retcode
          }`,
        },
        {
        ...
        },
        {
          short: true,
          value:
            `**${i18next.t('command.job.list.detail.PhaseName', { ns: 'ZosMessage' })}:** ` +
          ...
          attachments: [
            {
              pretext: i18next.t('common.data.foundOne', {
                executor: executor.name,
                resourceName: i18next.t('command.job.list.detail.resourceName', { ns: 'ZosMessage' }),
                ns: 'ZosMessage',
              }),
              fields: fields,
              actions: [],
