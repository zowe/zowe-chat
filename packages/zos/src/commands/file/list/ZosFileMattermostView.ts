...
class ZosFileSlackView extends ChatMattermostView {
    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              ...
              resourceName: i18next.t('command.file.list.status.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      for (file of files) {
        ...
        fields.push(
          {
            short: true,
            value: `${file.mode.startsWith('d') ? ':file_folder:' : ':page_facing_up:'} **${i18next.t(
              'command.file.list.status.name',
              { ns: 'ZosMessage' },
            )}: **${file.name}`,
          },
          {
      ...
      super.addMenuAction(
        actions,
        i18next.t('command.file.list.status.detailDropDownPlaceholder', { ns: 'ZosMessage' }),
        contextData,
        detailOptions,
      );
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              executor: executor.name,
              resourceName: i18next.t('command.file.list.detail.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
  ...
  getMountsOverview(fileSystems: Record<string, string | number>[], executor: IExecutor, command: ICommand): IMessage[] {
    ...
    try {
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              executor: executor.name,
              resourceName: i18next.t('command.file.list.mounts.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
      ...
      super.addMenuAction(
        actions,
        i18next.t('command.file.list.mounts.detailDropDownPlaceholder', { ns: 'ZosMessage' }),
        contextData,
        detailOptions,
      );
        ...
        return (messages = [
          {
            ...
            message: i18next.t('common.data.foundZero', {
              executor: executor.name,
              resourceName: i18next.t('command.file.list.mountsDetail.resourceName', { ns: 'ZosMessage' }),
              ns: 'ZosMessage',
            }),
          },
        ]);
